<template>
	<div
		class="min-h-screen flex items-center justify-center bg-[var(--bg)] text-[var(--text)]"
	>
		<form
		...
		>
            ...
            <p class="text-center text-sm text-muted mt-2">
                ...
                <a href="#" class="text-[var(--primary)] hover:underline" @click.prevent="$emit(`sign-in`)">Sign in</a>
            </p>
		</form>
	</div>
</template>
