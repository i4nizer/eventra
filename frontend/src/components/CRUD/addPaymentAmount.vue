              ...
              <div class="info-card">
                ...
                <div class="info-content">
                  ...
                  <div class="info-value balance">
                    ₱{{ studentInfo.balance?.toFixed(2) || "0.00" }}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div v-if="isValidAmount" class="amount-preview">
                ...
                <div class="preview-remaining">
                  Remaining after payment: ₱{{
                    formatAmount(studentInfo.balance - parseFloat(amount))
                  }}
                </div>
              </div>
            </div>
...
const errorMessage = computed(() => {
  ...
  if (props.studentInfo?.balance && numAmount > props.studentInfo.balance) {
    return `Amount cannot exceed outstanding balance of ₱${props.studentInfo.balance.toFixed(
      2
    )}`;
  }
  return "";
...
function validateAmount() {
  ...
  isValidAmount.value =
    !isNaN(numAmount) && numAmount > 0 && numAmount <= maxBalance;
}
