...
const run = async () => {
    ...
    models.student.Student.hasMany(models.violation.Violation, { foreignKey: "studentId", onDelete: "CASCADE" })
    ...
    models.activityEntry.ActivityEntry.hasMany(models.attendance.Attendance, { foreignKey: "entryId", onDelete: "CASCADE" })
    models.activityEntry.ActivityEntry.hasMany(models.violation.Violation, { foreignKey: "entryId", onDelete: "CASCADE" })
    ...
    models.attendance.Attendance.belongsTo(models.activityEntry.ActivityEntry, { as: "activityEntry", foreignKey: "entryId" })
    models.violation.Violation.belongsTo(models.student.Student, { as: "student", foreignKey: "studentId" })
    models.violation.Violation.belongsTo(models.activityEntry.ActivityEntry, { as: "activityEntry", foreignKey: "entryId" })
